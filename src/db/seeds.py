...
NICHE_SEEDS: list[dict[str, str]] = [
    ...
    {"name": "true_crime_documentary", "cat": "legal_crime", "desc": "Long-form true-crime documentary, case analysis, and investigation narrative", "evergreen": True},
    {"name": "legal_education", "cat": "legal_crime", "desc": "Legal concept explainers, court case breakdowns, and law-education content", "evergreen": True},
